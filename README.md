...
Use case: Customer purchasing behavior analysis and segmentation
...
2.2 Remove cancelled transactions (negative Quantity)
2.3 Handle missing CustomerID values
2.4 Aggregate transactional data at customer level
2.5 Normalize numerical features using StandardScaler


Step 3: Exploratory Data Analysis
3.1 Analyze distribution of purchase quantities and prices
3.2 Identify skewed features
3.3 Visualize relationships between aggregated customer features
3.4 Detect potential outliers in spending behavior


Step4: K-Means Clustering
4.1 Apply K-Means clustering on customer-level features
